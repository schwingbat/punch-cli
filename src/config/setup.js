...
module.exports = function(configPath) {
  ...
  console.log(
    "Let's set you up. I'll collect some information about you and your projects.\n"
  );

  console.log(
    "First some personal info. This is stored in a text file on your computer and transmitted (not saved) when generating an invoice.\n"
  );
